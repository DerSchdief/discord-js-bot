...
module.exports = async (self, target, coins) => {
  ...
  if (userDb.bank < coins) {
    return `Insufficient bank balance! You only have ${userDb.bank}${client.config.ECONOMY.CURRENCY} in your bank account.${
  ...
  const embed = new EmbedBuilder()
    ...
    .setDescription(`You have successfully transferred ${coins}${client.config.ECONOMY.CURRENCY} to ${target.username}`)
