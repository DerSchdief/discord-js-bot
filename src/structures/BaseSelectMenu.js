 ...
 * @property {function(import('discord.js').StringSelectMenuInteraction)} run - The callback to be executed when the context is invoked
 */

/**
 * @type {SelectMenuData} data - The context information
 */
module.exports = {
  id: "",
  description: "",
