 ...
 * @property {function(import('discord.js').ButtonInteraction)} run - The callback to be executed when the context is invoked
 */

/**
 * @type {ButtonData} data - The context information
 */
module.exports = {
  id: "",
  description: "",
